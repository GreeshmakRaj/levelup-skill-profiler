...
export default function RoadMapDetails() {
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <EmptyState title="Error loading roadmap" description={error} />
      </div>
    );
  }
  ...
  if (!roadmap) {
    return (
      <div className="space-y-6">
        <EmptyState title="Roadmap not found" description="The roadmap you're looking for doesn't exist or you don't have access to it." />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="btn-ghost text-sm" onClick={() => navigate("/roadmaps-list")}>
