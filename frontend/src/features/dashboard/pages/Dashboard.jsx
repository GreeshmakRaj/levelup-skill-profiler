      ...
      {isAssessor && (
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="btn-ghost text-sm" onClick={() => router.push('/learning-paths')}>View all →</button>
          </div>
          ...
          {dataLoading ? (
            ...
            <div className="card text-center py-10">
              ...
              <button className="btn-primary text-sm mt-3" onClick={() => router.push('/learning-paths')}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {skills.slice(0, 3).map((item) => (
                <LearningPathCard
                  key={item.skillId}
                  item={item}
                  onOpen={(it) => router.push(`/learning-paths?analysis=${it.skillId}`)}
